 ...
 * the prompt. Owns the live projection of the agent's session.
...
/**
 * The TUI root. Subscribes to the agent's session, dispatches user input to
 * the agent or to a slash command, and composes the three-pane layout.
 */
export const App: FC<AppProps> = ({ ctx, agent }) => {
